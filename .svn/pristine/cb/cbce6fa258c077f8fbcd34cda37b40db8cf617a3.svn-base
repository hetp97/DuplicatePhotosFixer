    ...
    public static class FileFunctions
    {
        ...
        private static string GetRealPath(string path)
        {
            try
            {
                ...
                /*
                 * string realPath;
                // If drive is subset, the result will be in the format of "\??\C:\RealPath\".
                if (pathInformation.ToString().Contains("\\??\\"))
                {
                    ...
                    //Combine the paths.
                    realPath = PathEx.Combine(realRoot, path.Replace(Path.GetPathRoot(path), ""));
                }
                else
                {
                    realPath = path;
        ...
        //public static cEnums.eErrorCodes GetDirectoryStatus(string folder)  /// will add cEnum class
        //{
        //    NTAccount acc = null;
        //    SecurityIdentifier secId = null;
        //    System.Security.AccessControl.AuthorizationRuleCollection authRules = null;
        ...
        //        //Step 1. Get the userName for which, this app domain code has been executing
        //        string executingUser = System.Security.Principal.WindowsIdentity.GetCurrent().Name;
        //        acc = new NTAccount(executingUser);
        //        secId = acc.Translate(typeof(SecurityIdentifier)) as SecurityIdentifier;

        //        DirectorySecurity dirSec = Directory.GetAccessControl(folder);

        //        //Step 2. Get directory permission details for each user/group
        //        authRules = dirSec.GetAccessRules(true, true, typeof(SecurityIdentifier));


        //        // as it is making it slow
        //        //foreach (FileSystemAccessRule ar in authRules)
        //        //{
        //        //    if (secId.CompareTo(ar.IdentityReference as SecurityIdentifier) == 0)
        //        //    {
        ...
        //        //            return cEnums.eErrorCodes.SUCCESS;
        //        //        }
        //        //    }
        //        //}
        //        //return hasAccess;
        ...
        //    {
        //        cGlobalSettings.oLogger.WriteLogException("DirectoryCanListFiles::UnauthorizedAccessException", ex);
        //        return cEnums.eErrorCodes.CLIENT_DIRECTORY_ACCESS_DENIED;
        //    }
        //    catch (System.IO.DirectoryNotFoundException ex)
        //    {
        //        cGlobalSettings.oLogger.WriteLogException("DirectoryCanListFiles::DirectoryNotFoundException", ex);
        //        return cEnums.eErrorCodes.CLIENT_DIRECTORYNOTFOUNDEXCEPTION;
        //    }
        //    catch (System.Exception ex)
        //    {
        //        int err = WinErrors.LogWin32Error();
        //        cEnums.eErrorCodes retCode = cEnums.eErrorCodes.FAILED;

        //        if (ex is System.UnauthorizedAccessException)
        //        {
        //            retCode = cEnums.eErrorCodes.CLIENT_DIRECTORY_ACCESS_DENIED;
        //        }
        //        else if (ex is System.IO.DirectoryNotFoundException)
        //        {
        //            retCode = cEnums.eErrorCodes.CLIENT_DIRECTORYNOTFOUNDEXCEPTION;
        //        }
        ...
        //        {
        //            retCode = cEnums.eErrorCodes.CIIENT_FILENOTFOUNDEXCEPTION;
        //        }
        //        else if (ex is System.IO.PathTooLongException)
        //        {
        //            retCode = cEnums.eErrorCodes.CLIENT_PATH_TOO_LONG;
        //        }
        ...
        //                else
        //                {
        //                    retCode = cEnums.eErrorCodes.FAILED;
        //                }
        //            }
        //            catch (System.Exception ex1)
        //            {
        //                cGlobalSettings.oLogger.WriteLogException(string.Format("DirectoryCanListFiles::Exception - ex is System.InvalidOperationException, Win32ErrorCode:{0}", err), ex1);
        //            }
        //            finally
        //            {
        //                di = null;
        ...
        //        cGlobalSettings.oLogger.WriteLogException(string.Format("DirectoryCanListFiles::Exception, Win32ErrorCode:{0}", err), ex);
        //        return retCode;
        //    }
        //    finally
        //    {
        ...
        /// <summary>
        /// Verifies file exist and its permission or is locked by other application
        /// </summary>
        /// <param name="sFilePath"></param>
        /// <returns></returns>
        //public static cEnum.eErrorCodes GetFileStatus(string sFilePath)
        //{
        ...
        //    catch (System.UnauthorizedAccessException ex)
        //    {
        //        cGlobalSettings.oLogger.WriteLogException("FileFunctions:UnauthorizedAccessException File does not have access permissions: " + sFilePath, ex);
        //        return cEnum.eErrorCodes.Failed;//CLIENT_FILE_ACCESS_DENIED;
        //    }
        //    catch (System.IO.FileNotFoundException ex)
        //    {
        //        cGlobalSettings.oLogger.WriteLogException("FileFunctions:FileNotFoundException Mark delete file as it is not found on user system: " + sFilePath, ex);
        //        return cEnum.eErrorCodes.Failed;
        //    }
        //    catch (System.IO.IOException ex)
        //    {
        //        int err = System.Runtime.InteropServices.Marshal.GetLastWin32Error();
        //        cGlobalSettings.oLogger.WriteLogException("FileFunctions:IOException-1" + sFilePath + ", win32 error:" + err.ToString(), ex);

        //        //SystemErrorCodes ec = (SystemErrorCodes)err;
        //        ///// to disable the retry for this file.
        //        //switch (ec)
        //        //{
        //        //    case SystemErrorCodes.ERROR_SHARING_VIOLATION:                    
        //        //        return cEnums.eErrorCodes.CLIENT_FILE_SHARING_VOILATION;
        //        //    case SystemErrorCodes.ERROR_FILE_NOT_FOUND:                    
        //        //    case SystemErrorCodes.ERROR_PATH_NOT_FOUND:                    
        //        //        return cEnums.eErrorCodes.BACKUP_FAILED_FILE_NOT_FOUND;                   
        //        //    case SystemErrorCodes.ERROR_ACCESS_DENIED:                    
        //        //        return cEnums.eErrorCodes.CLIENT_FILE_ACCESS_DENIED;             
        //        //    default:
        //        //        break;
        //        //}
        ...
        //        //    if (!fi.Exists)
        //        //    {
        //        //        return cEnum.eErrorCodes.BACKUP_FAILED_FILE_NOT_FOUND;
        //        //    }
        //        //}
        //        //catch (System.Exception ex1)
        //        //{
        //        //    cGlobalSettings.oLogger.WriteLogException("FileFunctions:IOException-2" + sFilePath + ", win32 error:" + err.ToString(), ex1);            
        //        //}
        ...
        //    catch (System.Exception ex)
        //    {
        //        cGlobalSettings.oLogger.WriteLogException("FileFunctions:Exception File access fails:" + sFilePath, ex);
        //        return cEnum.eErrorCodes.Failed;
        //    }
        //    finally
        //    {
        //        oFileStream.TryDispose();
        //        oFileStream = null;
        //    }

        //    return cEnum.eErrorCodes.Success;
        //}

        //public static cEnum.eErrorCodes CheckPermissonsToCreateFileFolder(string dirpath, cEnum.eErrorCodes defaultErrorCode)
        //{
        //    cEnum.eErrorCodes errorCode = cEnum.eErrorCodes.Success;

        //    try
        //    {
        //        string randomPath = Path.GetRandomFileName();
        //        string tryCreateFilePath = PathEx.Combine(dirpath, randomPath);
        //        string tryCreateFolderPath = PathEx.Combine(dirpath, Path.GetFileNameWithoutExtension(randomPath));

        //        if (!Directory.Exists(tryCreateFolderPath))
        //        {
        //            Directory.CreateDirectory(tryCreateFolderPath);
        //            Directory.Delete(tryCreateFolderPath);
        //        }

        //        if (!File.Exists(tryCreateFilePath))
        //        {
        //            using (FileStream fs = File.Create(tryCreateFilePath))
        //            {
        //                fs.Close();
        //                fs.Dispose();
        //            }

        //            File.Delete(tryCreateFilePath);
        //        }
        //    }
        //    catch (System.Exception ex)
        //    {
        //        /// get win32 error
        //        //int win32Error = WinErrors.LogWin32Error();

        //        //if (ex is System.UnauthorizedAccessException)
        //        //{
        //        //    errorCode = cEnums.eErrorCodes.CLIENT_DIRECTORY_ACCESS_DENIED;
        //        //}
        //        //else if (ex is System.IO.DirectoryNotFoundException)
        //        //{
        //        //    errorCode = cEnums.eErrorCodes.CLIENT_DIRECTORYNOTFOUNDEXCEPTION;
        //        //}
        //        //else if (ex is System.IO.DriveNotFoundException)
        //        //{
        //        //    errorCode = cEnums.eErrorCodes.CLIENT_DIRECTORYNOTFOUNDEXCEPTION;
        ...
        //        //else if (ex is System.IO.FileNotFoundException)
        //        //{
        //        //    errorCode = cEnums.eErrorCodes.CIIENT_FILENOTFOUNDEXCEPTION;
        //        //}
        //        //else if (ex is System.IO.PathTooLongException)
        //        //{
        //        //    errorCode = cEnums.eErrorCodes.CLIENT_PATH_TOO_LONG;
        //        //}
        //        //else if (ex is System.IO.IOException)
        //        //{
        //        //    if (win32Error == (int)SystemErrorCodes.ERROR_SHARING_VIOLATION)
        //        //    {
        //        //        errorCode = cEnums.eErrorCodes.CLIENT_FILE_SHARING_VOILATION;
        //        //    }
        //        //    else
        //        //    {
        ...
        //        cGlobalSettings.oLogger.WriteLogException("CheckPermissonsToCreateFileFolder::Win32ErrorCode:", ex);
        //    }
