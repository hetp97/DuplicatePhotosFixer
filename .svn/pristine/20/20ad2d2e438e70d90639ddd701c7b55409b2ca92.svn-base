...
namespace DuplicatePhotosFixer.HelperClasses
{
    ...
    namespace MyLogger
    {
        ...
        const int MaxCount = 64;
            ...
            public bool WriteLogVerbose(string sMessage, bool bEncypted = false, bool bForceWrite = true)
            {
                try
                {
                    if (bVerboseLoggingEnabled)
                    {
                        //////if (!cGlobalSettings.isMD5LoggingEnabled)
                        //////{
                        //////    return false;
                        //////}
        ...
        public static class PathEx
        {
            ...
            /// <returns></returns>
            static public string DirectorySeparatorChar = Path.DirectorySeparatorChar.ToString();
            ...
            public static DateTime TruncateTime(this DateTime dateTime, TimeSpan timeSpan)
            {
