    ...
    public class cRegistrySettings
    {
       ...
       public void LoadGeneralSettings()
        ...
        public void LoadFileFormatMinSizeSettings()
        {
            try
            {
                var minSizeVal = cGlobalSettings.GetUserAppDataRegistryValue(enumClass.eRegistryKeys.minSize.ToString(), (long)0);
                cGlobalSettings.MinFileSize = Convert.ToInt64(minSizeVal);

                var minSizeInVal = cGlobalSettings.GetUserAppDataRegistryValue(enumClass.eRegistryKeys.minSizeIn.ToString(), (int)0);
                cGlobalSettings.MinFileSizeIn = Convert.ToInt16(minSizeInVal);
            }
            catch (Exception ex)
            {
